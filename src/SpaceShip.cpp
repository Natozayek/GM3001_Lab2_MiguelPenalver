...
void SpaceShip::m_Move()
{
	...
	if (arrivalMove == true)
	{
		...
		if(Util::distance(m_destination,  getTransform()->position) < slow)
		{
			/*m_accelerationRate = m_accelerationRate / distance(m_destination, getTransform()->position);*/
			m_maxSpeed = m_maxSpeed * (distance(m_destination, getTransform()->position) / slow);
		}
	}
